    ...
    <head>
      ...
      <!--  <link rel="shortcut icon" href="assets/images/favicon.ico">-->
        ...
        <style>
            ...
            #sidebar-menu ul li.has_sub ul.list-unstyled li a:hover {
                color: #fff !important;
                    ...
                    <div id="sidebar-menu">
                        <ul>
                         ...
                         <!--   <li class="has_sub">
                            ...
                            <li class="menu-title">Data Monitor</li>
                             <li class="has_sub">
                                <a href="javascript:void(0);" class="waves-effect"><i class="mdi mdi-monitor"></i><span> Rekap</span> <span class="float-right"><i class="mdi mdi-chevron-right"></i></span> </a>
                                <ul class="list-unstyled">
                            ...
                            <li>
                                <a href="entridata.php" target="frame2367" class="waves-effect"><i class="mdi mdi-database-plus"></i><span>Entri Data</span></a>
                            </li>
                              <li>
                                <a href="ukurgardu.php" target="frame2367" class="waves-effect"><i class="mdi mdi-database-plus"></i><span>Upload Ukur Gardu</span></a>
                            </li>
                          <!--  <li class="has_sub">
