        ...
        <div class="card-body">
            <div class="row">
                <div class="col-md-4 col-12 mb-3">
                    ...
                    <select class="select2 form-control custom-select" name="bulan" required style="width: 100%;">
                ...
                <div class="col-md-4 col-12 mb-3">
                    ...
                    <select class="select2 form-control custom-select" name="tahun" required style="width: 100%;">
                        <option value=""></option>
                        <?php
                        $tahunSekarang = '2020';
                        $tahunMaju = 30;
